      ...
      <div className='flex h-screen flex-col items-center justify-center'>
        ...
        >
          ...
          <div className='flex flex-row justify-center'>
            <img src={googleLogo} alt="구글로그인 로고"className='mr-[9px] h-[50px] w-[50px]' />
            <img src={kakaoLogo} alt="카카오로그인 로고" className='mx-[9px] h-[50px] w-[50px]' />
            <img src={naverLogo} alt="네이버로그인 로고" className='ml-[9px] h-[50px] w-[50px]' />
          </div>
        </form>
      </div>
    </div>
