...
const Home = () => {
  return (
    <section>
      ...
      <article className='h-[100vh] bg-white'>
        <div className='inner mx-auto flex w-[1590px] justify-between border-2 pt-[230px]'>
          <div>
            ...
            <p className='text-[20px] leading-10'>
              ...
              <br />
              <span className='bg-secondary p-1 font-medium'>
          ...
          <img src={character} aria-hidden alt='' />
        </div>
      </article>
      <article className='bg-primary'>
        <div className='inner mx-auto mb-[330px] w-[1590px] pt-[112px]'>
          ...
          <div className='flex items-center'>
            ...
            <p className='ml-[60px] text-[20px] leading-10 text-white'>
              도시락도 락이다는 당신만을 위한{' '}
              <span className='text-secondary'>맞춤 도시락 서비스</span>입니다.
              <br />
        ...
        <div className='relative flex items-center pb-[270px]'>
          <img className='absolute right-0' alt='' src={truck} aria-hidden />
          <div className='inner mx-auto w-[1590px]'>
            <p className='text-[20px] leading-10 text-white'>
              바쁜 일상 속에서도 건강하고 신선한 식사를 놓치지 마세요!
              <br />
              저희만의 <span className='text-secondary'>새벽배송</span> 서비스로
              이른 새벽, 신선한 재료로 만든 나만의 커스텀 도시락이 출근 전에
              도착합니다.
              <br />
              가벼운 클릭 한번으로{' '}
            ...
            <ul>
              ...
              <li className='mb-[45px] flex h-[245px] w-[660px] items-center justify-center rounded-[18px] bg-secondary bg-opacity-30 backdrop-blur-[50px]'>
                <div className='flex w-full items-center'>
                  ...
                  <p className='text-lg'>
                    알레르기가 많아서 ... 매번 알레르기 유발음식이 있는지 없는지
                    <br />
